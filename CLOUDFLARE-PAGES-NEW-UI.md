...
| **部署命令** | Deploy command (必需) | `wrangler pages deploy .next` | **必需** ⚠️ |
...
```
- ⚠️ **这是最关键的配置**
- 必须填写 `wrangler pages deploy .next`
- 不能使用 `npx wrangler deploy`
